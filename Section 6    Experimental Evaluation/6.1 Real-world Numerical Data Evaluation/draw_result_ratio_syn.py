...
plt.rcParams["hatch.color"] = "#00ff00"
...
# plt.show()
fig.savefig("compression_ratio_syn.eps", format="eps", dpi=400, bbox_inches="tight")
fig.savefig("compression_ratio_syn.png", dpi=400, bbox_inches="tight")
