...
RESULT_PATH = "./result_ingestion_syn.csv"

# header="DataSet,DataType,Compressor,Encoding,Insert Time,Select Time\n"

os.chdir(os.path.dirname(os.path.abspath(__file__)))
df = pd.read_csv('../../Synthetic_Numerical_result.csv')
...
df['Compressor'] = df['Compress Algorithm'].apply(name_convert)
...
df = df[['DataSet', 'DataType', 'Compressor',
