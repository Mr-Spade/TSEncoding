...
axes[0].locator_params(axis='x', integer=True)
# plt.legend()
# plt.tight_layout()
...
fig.savefig("feature_engineering_new.eps", bbox_inches="tight")
fig.savefig("feature_engineering_new.png", bbox_inches="tight")
# plt.clf()
