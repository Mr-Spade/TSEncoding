...
Encoders = ["HUFFMAN", "MTF", "BW", "DICTIONARY", "RLE", "AC"]
...
# fig.legend(lines)
# plt.show()
fig.savefig("features-encoding_text.eps", format="eps", dpi=400, bbox_inches="tight")
fig.savefig("features-encoding_text.png", dpi=400, bbox_inches="tight")
