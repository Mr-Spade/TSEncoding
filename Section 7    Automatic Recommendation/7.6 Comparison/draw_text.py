...
fmri = pd.read_csv("compare_text.csv")
data1 = pd.concat(
    [
...
ax_arr = fig.add_axes([0.43, 0, 0.22, 0.8])
f = sns.barplot(
    x="Indicator",
    y="Value",
    hue="Recommender",
...
ax_arr = fig.add_axes([0.74, 0, 0.22, 0.8])
f = sns.barplot(
    x="Indicator",
    y="Value",
    hue="Recommender",
...
fig.savefig("compare_ratio_text.eps", format="eps", dpi=400, bbox_inches="tight")
fig.savefig("compare_ratio_text.png", dpi=400, bbox_inches="tight")
