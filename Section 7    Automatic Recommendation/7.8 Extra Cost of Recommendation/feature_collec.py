...
def statistic(data):
    ...
    return "{},{},{},{},{},{},{},{},{},{},{}".format(
        ave, std, std_spread, drop_nan(pycatch22.SB_BinaryStats_mean_longstretch1(data.tolist())),
        diff_ave, diff_std, diff_spread, drop_nan(pycatch22.MD_hrv_classic_pnn40(data.tolist())),
        repeat, nrepeat,
        sort
    )
...
RESULT1_PATH = "./time_real_world_insert_extraction.csv"  ###
...
dataset = "Datasets/Real-world/Numerical/INT32" ###
